...
public class ContactFormController {
	...
	// Agregar anotaci�n @Valid a ContactForm para que @InitBinder valide
	public String submitForm(Model model, @Validated @ModelAttribute("contactForm") ContactForm form, BindingResult result) {
