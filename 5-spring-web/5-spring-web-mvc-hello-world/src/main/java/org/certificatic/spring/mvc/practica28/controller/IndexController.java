...
class IndexController {
	...
	public String showIndexPage(Model model) {
		...
		model.addAttribute("message","Elioth !");
		return "index";
	}
	@RequestMapping(value= {"/message/{name}"}, method=RequestMethod.GET)
	public String showIndexPage2(Model model, @PathVariable("name") String name) {
		// Agregar mensaje "message" al modelo
		model.addAttribute("message",name+"!");
		return "index";
	}
	@RequestMapping(value= {"/name"}, method=RequestMethod.GET)
	public String showIndexPage3(Model model, @RequestParam("name") String name) {
		// Agregar mensaje "message" al modelo
		model.addAttribute("message",name+"!");
		return "index";
	}
