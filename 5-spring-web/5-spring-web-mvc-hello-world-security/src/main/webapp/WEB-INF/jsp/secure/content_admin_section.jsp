...
<script>
	$(document).ready(function() {
		$("input[data-call-method=adminMethod]").on("click", function() {
			document.location.href="${site_url}adminSection?callmethod=admin";
		});
		$("input[data-call-method=rootMethod]").on("click", function() {
			document.location.href="${site_url}adminSection?callmethod=root";
		});
		$("input[data-call-method=userMethod]").on("click", function() {
			document.location.href="${site_url}adminSection?callmethod=user";
		});
	});
</script>
