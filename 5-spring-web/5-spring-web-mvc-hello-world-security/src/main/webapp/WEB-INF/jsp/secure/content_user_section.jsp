...
<script>
	$(document).ready(function() {
		$("input[data-call-method=adminMethod]").on("click", function() {
			document.location.href = "${site_url}userSection?callmethod=admin";
		});
		$("input[data-call-method=rootMethod]").on("click", function() {
			document.location.href = "${site_url}userSection?callmethod=root";
		});
		$("input[data-call-method=userMethod]").on("click", function() {
			document.location.href = "${site_url}userSection?callmethod=user";
		});
	});
</script>
