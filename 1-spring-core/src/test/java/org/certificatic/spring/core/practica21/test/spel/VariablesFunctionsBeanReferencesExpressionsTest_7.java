...
public class VariablesFunctionsBeanReferencesExpressionsTest_7 {
	...
	public static void setUp() {
		...
		MyBeanResolver myBeanResolver = applicationContext.getBean(MyBeanResolver.class);
	...
	public void variablesExpressionsTest() {
		...
		int numero = magician.getInitialNumber();

		springContext.setVariable("magicNumber", numero); // sólo analizar

		// defnir y obtener el valor de una expresión que acceda al bean guessNumberBean definido en el aplication-context.xml
